    ...
    if renpy.get_screen("main_menu"):
        ...
        vbox:
            ...
            if main_menu:
                ...
                imagebutton auto "gui/button/start_%s.png" xpos -330 ypos 903 focus_mask True action Start()
            ...
            imagebutton auto "gui/button/loadgame_%s.png" xpos -1125 ypos 754 focus_mask True action ShowMenu("load")

            #textbutton _("menu") action ShowMenu("preferences")
            imagebutton auto "gui/button/menu_%s.png" xpos 158 ypos 603 focus_mask True action ShowMenu("preferences")
            ...
            if renpy.variant("pc"):
                ...
                ## 합니다.
                #textbutton _("close") action Quit(confirm=not main_menu)
                imagebutton auto "gui/button/close_%s.png" xpos 548 ypos 450 focus_mask True action Quit(confirm=not main_menu)
...
screen main_menu():
    ...
    #imagebutton auto "gui/start_%s.png" xpos -1194 ypos 150 focus_mask True action Start()
...
style game_menu_outer_frame:
    ...
    background "gui/overlay/bg_menu.png"
...
screen game_over():
    add gui.game_over_background
    vbox:
        xalign 0.543
        yalign 0.2
        imagebutton auto ("gui/button/game_over_%s.png") action Return()

screen goodbye():
    add  "gui/thankyou.png"
    vbox:
        xalign 0.05
        yalign 0.05
        imagebutton auto ("gui/button/inven_%s.png") action Return()
    

#default initem_descriptions = {"팥" : "팥 붕어빵을 만들기 위한 속재료이다.", "슈크림" : "슈크림 붕어빵을 만들기 위한 속재료이다.", "초콜릿" : "초콜릿 붕어빵을 만들기 위한 속재료이다.", "피자" : "피자 붕어빵을 만들기 위한 속재료이다.", "벌집" : "탕후루 붕어빵을 만들기 위한 속재료이다."}
#default nftitem_descriptions = {"붕어빵" : "맛있는 붕어빵이다!", "얼어버린 붕어빵" : "너무 차가운 사람이었어!", "축하하는 붕어빵" : "어릴 적 추억이 가득한 피자 붕어빵을 얻었어!", "축하해요! 붕어빵" : "졸업 축하해!", "빙글뱅글 붕어빵" : "시험 공부는 너무 어려워!"}


#default item_descriptions = ["팥" : "팥 붕어빵을 만들기 위한 속재료이다.", "슈크림" : "슈크림 붕어빵을 만들기 위한 속재료이다.", "초콜릿" : "초콜릿 붕어빵을 만들기 위한 속재료이다.", "피자" : "피자 붕어빵을 만들기 위한 속재료이다.", "벌집" : "탕후루 붕어빵을 만들기 위한 속재료이다.", "붕어빵" : "맛있는 붕어빵이다!", "얼어버린 붕어빵" : "너무 차가운 사람이었어!", "축하하는 붕어빵" : "어릴 적 추억이 가득한 피자 붕어빵을 얻었어!", "축하해요! 붕어빵" : "졸업 축하해!", "빙글뱅글 붕어빵" : "시험 공부는 너무 어려워!"]
#default inventory_items = ["팥" : "팥 붕어빵을 만들기 위한 속재료이다.", "붕어빵" : "맛있는 붕어빵이다!", "얼어버린 붕어빵" : "너무 차가운 사람이었어!", "축하하는 붕어빵" : "어릴 적 추억이 가득한 피자 붕어빵을 얻었어!", "축하해요! 붕어빵" : "졸업 축하해!", "빙글뱅글 붕어빵" : "시험 공부는 너무 어려워!"]

"""
init python :
    default inventory_items = ["gui/orignal.png", "gui/pat.png", "gui/suhcream.png", "gui/chocolat.png", "gui/pizza.png", "gui/honey.png"]

    item_name = {
        "gui/orignal.png" : "붕어빵", 
        "gui/pat.png" : "팥소", 
        "gui/suhcream.png" : "슈크림", 
        "gui/chocolat.png": "초콜릿", 
        "gui/pizza.png": "피자", 
        "gui/honey.png" : "벌꿀집"
    }
    ...
    description = {
        "gui/orignal.png" : "붕어빵", 
        "gui/pat.png" : "5개를 모으면 팥 붕어빵을 만들 수 있다", 
        "gui/suhcream.png" : "5개를 모으면 슈크림 붕어빵을 만들 수 있다.", 
        "gui/chocolat.png": "5개를 모으면 초콜릿 붕어빵을 만들 수 있다.", 
        "gui/pizza.png": "5개를 모으면 피자 붕어빵을 만들 수 있다.", 
        "gui/honey.png" : "5개를 모으면 탕후루 붕어빵을 만들 수 있다."
    }"""
...
screen inventory_item_description:
    ...
    modal True
    add "gui/inventory.png" xpos 0.01


    if item_boong == 1:
        add im.FactorScale("gui/original_boong.png", 0.7) :
            xpos 0.137
            ypos 0.419
        ...
        add im.FactorScale("gui/pat.png", 0.7) :
            xpos 0.293
            ypos 0.419
        ...
        add im.FactorScale("gui/shucream.png", 0.7) :
            xpos 0.293
            ypos 0.419
        ...
        add im.FactorScale("gui/chocolat.png", 0.7) :
            xpos 0.293
            ypos 0.419
        ...
        add im.FactorScale("gui/pizza.png", 0.7) :
            xpos 0.293
            ypos 0.419   

    elif (item_tang_1 == 1 and item_pat_1 == 0):
        add im.FactorScale("gui/original_boong.png", 0.7) :
            xpos 0.137
            ypos 0.419

        add im.FactorScale("gui/honey.png", 0.7) :
            xpos 0.293
            ypos 0.419  

    elif (item_tang_1 == 1 and item_shu_1 == 0):
        add im.FactorScale("gui/original_boong.png", 0.7) :
            xpos 0.137
            ypos 0.419
    ...
    elif (item_tang_1 == 1 and item_pi_1 == 0):
        add im.FactorScale("gui/original_boong.png", 0.7) :
            xpos 0.137
            ypos 0.419
    ...
    elif (item_tang_1 == 1 and item_cho_1 == 0):
        add im.FactorScale("gui/original_boong.png", 0.7) :
            xpos 0.137
            ypos 0.419
    ...
    on "hide" action SetVariable("item_descriptions", "") 
