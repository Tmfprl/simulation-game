...
define config.name = _("Bung_O_Pang")
...
define config.main_menu_music = "audio/50mang_Merope.ogg"
...
define config.save_directory = "Bung_O_Pang-1711610552"
