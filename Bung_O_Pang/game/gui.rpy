...
define gui.accent_color = '#cc7a00'

## 텍스트 버튼(text button)이 선택(selected)됐거나 커서를 올리지(hovered) 않았을
## 때 사용됩니다.
define gui.idle_color = '#751244'
...
define gui.muted_color = '#422703'
define gui.hover_muted_color = '#7a4500'
...
define gui.main_menu_background = "gui/main.png"
define gui.game_menu_background = "gui/bg_menu.png"
define gui.game_over_background = "gui/game_over.png"
